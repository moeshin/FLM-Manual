...
**注意：**应用内购买（例如 FL Studio Mobile 本身）不可在操作系统（Android、iOS和Windows）之间转移。有关为什么这样做的更多详细信息，请参见 [此知识库文章](https://support.image-line.com/knowledgebase/base.php?ans=497)。
